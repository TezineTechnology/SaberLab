...
class EIuguCancelInvoiceResponse{
	String id;
	String due_date;
	String currency;
	...
	factory EIuguCancelInvoiceResponse.fromJson(Map<String, dynamic> json){
		return EIuguCancelInvoiceResponse(
