...
class EIuguReembolsarFaturaResponse{
	String id;
	String due_date;
	String currency;
	...
	factory EIuguReembolsarFaturaResponse.fromJson(Map<String, dynamic> json){
		return EIuguReembolsarFaturaResponse(
